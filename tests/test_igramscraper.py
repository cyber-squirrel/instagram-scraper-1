...
from tests.context import Instagram, Media  # noqa: F401
from tests.test_data import password, user_agent, username

# from unittest.mock import patch
# TODO: Implement mocks for endpoint testing
...
class TestIgramscraper(unittest.TestCase):
    ...
    def test_get_account_by_id_with_invalid_numeric_id(self):
        # sys.maxsize is far larger than the greatest id so far and thus does not
        # represent a valid account.
        try:
